...
The **nichevol** R package helps to perform critical steps in the process of assessment of  species' ecological niche evolution, with uncertainty incorporated in reconstructions. The main analyses include: initial exploration of environmental data in species records and accessible areas, preparation of data for phylogenetic analyses, comparative phylogenetic analyses, and plotting for interpretations.
...
The stable version of **nichevol** is in **CRAN** and it can be installed and loaded using the code below (we are working on this):
...
The most recent version of **nichevol** is available as a GitHub repository and can be installed using the code below. Please, have in mind that updates will be done on this version continuously.
