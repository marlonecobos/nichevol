...
These module is still under development but it is intended to help in creating a suit of virtual species niches and their phylogenetic relationships to explore hypothesis of niche evolution.
...
The following lines of code will help to get example data prepared for demonstrating the usage of **nichevol**. These data were used in an article in which the methods implemented in **nichevol** were proposed, illustrated, and explained (see Owens et al. in review). These data are included in the package, so its use if straightforward. 
